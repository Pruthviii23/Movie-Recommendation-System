...
df = pd.read_csv("C:\\Users\\india\\Desktop\\Movie-Recommendation-System\\WhatMovieToWatch\\indian_movies_2000_2025.csv")
...
OCCASION_RULES = {
    "Just watching a movie": {"exclude_tags": []},
    "Movie date": {"exclude_tags": ["Horror", "Extreme", "Violence"]},
    "Family movie time": {"exclude_tags": ["Violence", "Adult", "Dark", "Crime"]},
    "Friends movie time": {"exclude_tags": []},
    "Binge watch": {"exclude_tags": []},
    "Solo watch": {"exclude_tags": []}
}
...
def recommend_movies(occasion, genres, interests, mood, recency, top_n=10):
    ...
    similarity = cosine_similarity(user_vec, tfidf_matrix[filtered_idx])[0]
